...
public class SparkStreamingFromKafka_WordCount {
    ...
    public static void main(String[] args) {
        ...
        JavaStreamingContext jssc= new JavaStreamingContext(sparkConf,new Duration(5 * 1000));// 5秒
        ...
        */
        ...
        /*
         //实验3：窗口操作，reduceByKeyAndWindow函数，统计每隔5秒计算一下最近30秒的每个单词总数
        Function2<Integer, Integer, Integer> reduceFunc = new Function2<Integer, Integer, Integer>() {
           public Integer call(Integer i1, Integer i2) {
                return i1 + i2;
            }
        };
        JavaPairDStream<String, Integer> wordcount = pairs.reduceByKeyAndWindow(reduceFunc, Durations.seconds(30), Durations.seconds(1));
        */
        //output操作: 触发job执行
        wordcount.print();
