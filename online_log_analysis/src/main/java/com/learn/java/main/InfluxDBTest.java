...
public class InfluxDBTest {
	...
	public void testWriteMultipleStringData() {
		...
		String dbName ="online_log_analysis";
		...
		//System.out.print("cpu,atag=test1 idle=100,usertime=10,system=1"+"\n"+"cpu,atag=test2 idle=200,usertime=20,system=2"+"\n"+"cpu,atag=test3 idle=300,usertime=30,system=3");

		//this.influxDB.write(dbName, rp, InfluxDB.ConsistencyLevel.ONE, "cpu,atag=test1 idle=100,usertime=10,system=1\ncpu,atag=test2 idle=200,usertime=20,system=2\ncpu,atag=test3 idle=300,usertime=30,system=3");
		this.influxDB.write(dbName, rp, InfluxDB.ConsistencyLevel.ONE, "logtype_count,host_service_logtype=flume-agent-01_namenode_ERROR count=1\nlogtype_count,host_service_logtype=flume-agent-02_datanode_ERROR count=1\nlogtype_count,host_service_logtype=flume-agent-03_datanode_ERROR count=1");
